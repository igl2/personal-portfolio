            ...
            <div class="container">
                ...
                <div class="hobbies-grid">
                    <div class="hobbies-card">
                        ...
                        <h4>Involvement</h4>
                        <p class="hobbies-text">In addition to programming, I am also active in other areas of my life. I participate in various activities such as church involvement, clubs, volunteering, and working as a part-time waiter.</p>
                    </div>
                    <div class="hobbies-card">
                        ...
                        <p class="hobbies-text">With a degree in Software Design and Development, I have learned the fundamentals of software engineering and
                    ...
                    <div class="hobbies-card">
                        ...
                        <p class="hobbies-text">I try my best not to live a sedentary lifestyle. Therefore, I'll do what it takes to get my body moving
